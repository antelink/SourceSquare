 ...
 */
package com.antelink.sourcesquare.event.handlers;

import java.util.Set;

import com.antelink.sourcesquare.event.base.ClientEventHandler;

public interface CreateTreeMapNodeEventHandler extends ClientEventHandler {
    public void handle(String path, Set<String> children, int nbFiles);
}
