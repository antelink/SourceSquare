...
public class ScanCompleteEvent implements ClientEvent<ScanCompleteEventHandler> {

    public static final ClientEventType<ScanCompleteEventHandler> TYPE = new ClientEventType<ScanCompleteEventHandler>();

    
    ArrayList<Integer> levels;
    
    public ScanCompleteEvent(ArrayList<Integer> levels){
    	this.levels=levels;
    }
    @Override
    public ClientEventType<ScanCompleteEventHandler> getHandlerType() {
        return TYPE;
    }

    @Override
    public void dispatch(ScanCompleteEventHandler handler) {
        handler.handle(levels);
    }
