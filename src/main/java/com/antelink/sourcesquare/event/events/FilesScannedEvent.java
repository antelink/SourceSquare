...
public class FilesScannedEvent implements ClientEvent<FilesScannedEventHandler> {

    public static final ClientEventType<FilesScannedEventHandler> TYPE = new ClientEventType<FilesScannedEventHandler>();
    ...
    @Override
    public ClientEventType<FilesScannedEventHandler> getHandlerType() {
        return TYPE;
    }
