...
public class AntepediaLocations {

    public String getBaseDomain() {
        return System.getProperty("antepedia.api.domain", "api.antepedia.com");
    }

    private String getBasePath() {
        return "https://" + getBaseDomain() + System.getProperty("antepedia.api.path", "/acme/v2");
    }

    public String getBinaryBatchQueryUrl() {
        return getBasePath() + "/bquery";
    }
}
