...
import com.antelink.sourcesquare.server.EmbeddedServer;
...
public class EmbeddedSimulator {
	...
	public static void main(String[] args) {
		...
		server.getServletContext().addServlet( new ServletHolder(new SimulationController(eventBus)), "/simulation");
		try {
			server.startServer();
		} catch (Exception e) {
			e.printStackTrace();
